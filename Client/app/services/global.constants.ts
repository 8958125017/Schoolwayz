...
export class AppSettings {
    ...
    public static API_ENDPOINT = 'http://dev.schoolwayz.com/api/';
    ...
    public static ALLROUTE_MARKER = AppSettings.IMAGE_ENDPOINT + 'allRouteIcon.png';//'bus2.png';
    public static COMMING_STOP_MARKER = AppSettings.IMAGE_ENDPOINT + 'commingStopIcon.png';
    public static COVERED_STOP_MARKER = AppSettings.IMAGE_ENDPOINT + 'coverdStopIcon.png';
